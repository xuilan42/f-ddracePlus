...
// F-DDrace: Black hole grenade tuning
MACRO_TUNING_PARAM(BlackholeFireDelay, blackhole_fire_delay, 500, "Delay of firing black hole grenade")
MACRO_TUNING_PARAM(BlackholeAbsorbRadius, blackhole_absorb_radius, 1.5f, "Initial radius of black hole (in blocks)")
MACRO_TUNING_PARAM(BlackholePullForce, blackhole_pull_force, 5.0f, "Force pulling players towards black hole")
MACRO_TUNING_PARAM(BlackholeLifetime, blackhole_lifetime, 5, "Lifetime of black hole in seconds")
#endif
