...
CONSOLE_COMMAND("ninjasword", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConNinjaSword, this, "Toggles ninja sword mode for player v", AUTHED_ADMIN)
...
CONSOLE_COMMAND("invincible", "?v[id]", CFGFLAG_SERVER|CMDFLAG_TEST, ConInvincible, this, "Toggles invincibility for player v", AUTHED_ADMIN)
