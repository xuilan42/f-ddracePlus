...
MACRO_CONFIG_STR(EcBindaddr, ec_bindaddr, 128, "localhost", CFGFLAG_SAVE|CFGFLAG_SERVER|CFGFLAG_ECON, "Address to bind the external console to. Anything but 'localhost' is dangerous", AUTHED_ADMIN)
MACRO_CONFIG_INT(EcPort, ec_port, 0, 0, 0, CFGFLAG_SAVE|CFGFLAG_SERVER|CFGFLAG_ECON, "Port to use for the external console", AUTHED_ADMIN)
MACRO_CONFIG_STR(EcPassword, ec_password, 32, "", CFGFLAG_SAVE|CFGFLAG_SERVER|CFGFLAG_ECON, "External console password", AUTHED_ADMIN)
MACRO_CONFIG_INT(EcBantime, ec_bantime, 0, 0, 1440, CFGFLAG_SAVE|CFGFLAG_SERVER|CFGFLAG_ECON, "The time a client gets banned if econ authentication fails. 0 just closes the connection", AUTHED_ADMIN)
MACRO_CONFIG_INT(EcAuthTimeout, ec_auth_timeout, 30, 1, 120, CFGFLAG_SAVE|CFGFLAG_SERVER|CFGFLAG_ECON, "Time in seconds before the the econ authentification times out", AUTHED_ADMIN)
MACRO_CONFIG_INT(EcOutputLevel, ec_output_level, 1, 0, 2, CFGFLAG_SAVE|CFGFLAG_SERVER|CFGFLAG_ECON, "Adjusts the amount of information in the external console", AUTHED_ADMIN)
...
MACRO_CONFIG_STR(SvGametype, sv_gametype, 32, "DDRace", CFGFLAG_SERVER|CFGFLAG_SAVE, "Custom game type displayed in server browser", AUTHED_ADMIN)
...
MACRO_CONFIG_INT(SvCaptcha, sv_captcha, 1, 0, 1, CFGFLAG_SERVER, "Require captcha on join before player can move/chat", AUTHED_ADMIN)
